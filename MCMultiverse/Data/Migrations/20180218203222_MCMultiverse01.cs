        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinecraftUUID = table.Column<string>(nullable: true),
                    MinecraftUserName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannerLarge = table.Column<byte[]>(nullable: true),
                    BannerLargeContentType = table.Column<string>(nullable: true),
                    BannerSmall = table.Column<byte[]>(nullable: true),
                    BannerSmallContentType = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataContentType = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_MCServers_MCServerId",
                        column: x => x.MCServerId,
                        principalTable: "MCServers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
